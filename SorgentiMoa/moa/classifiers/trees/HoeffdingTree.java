...
public class HoeffdingTree extends AbstractClassifier {
    ...
    public static class ActiveLearningNode extends LearningNode {
        ...
        public double weightSeenAtLastSplitEvaluation;
     ...
     //       System.out.println(inst.weight());
            for (int i = 0; i < inst.numAttributes() - 1; i++) {
                ...
                obs.observeAttributeClass(inst.value(instAttIndex), (int) inst.classValue(), (int)inst.weight());
            }
        }
